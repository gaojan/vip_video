...
class DownloadVideo(object):
    def __init__(self, url):
        self.base_url = 'http://jx.618g.com/?url=' + url
    ...
    def parse_page(self, html):
        ...
        """
        el = etree.HTML(html)
        self.title = el.xpath('//title/text()')[0]
        print(self.title)
        ...
        self.ts_list = self.get_m3u8_2(self.url)  # 'd8c37751d3e000000.ts'
    ...
    def ts_to_mp4(self):
        print('ts文件正在转录mp4...')
        # cmd_str = 'cp -R ' + self.title.replace(' ', '/ ') + '*.ts ' + self.title.replace(' ', '/ ')+'.mp4'
        cmd_str = 'ffmpeg -i /Users/gaojian/python_study/video/古董局中局第11集/*.ts /Users/gaojian/python_study/video/古董局中局第11集/ddd.mp4'
        os.system('y')
        print(cmd_str)
        os.system(cmd_str)
